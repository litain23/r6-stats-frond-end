...
import R6ToggleButton, { ToggleButtonProps } from '../Components/R6ToggleButton'
...
const R6ToggleButtonGroup = ({children, currentValue, onChange}:Props<number>) => {
    ...
    return(
        <DIV>
            ...
            map(children, (child, index, total)=> {
                ...
                const { value : childVal } = (child.props as ToggleButtonProps)
