                ...
                <Row className="wrapper">
                    <Col xs={3}>
                        <Container>
                            ...
                            <Row className="wrapper">
                                <h5> {(this.state.generalData.totalMatchWon)/(this.state.generalData.totalMatchPlayed)*100}%</h5>
                            </Row>
                        </Container>
                    </Col>
                        <Col xs={6}>
                            ...
                            data={[
                                ...
                                color: '#e84057',
                                title: 'Win',
                                value: this.state.generalData.totalMatchWon
                                },
                                {
                                color: '#5383e8',
                                title: 'Lose',
                                value: this.state.generalData.totalMatchPlayed - this.state.generalData.totalMatchWon
                                }
                            ]}
                            label={false}
                            labelPosition={50}
                    ...
                    <Col xs={3}>
                        <Container>
                            ...
                            <Row className="wrapper">
                                <h5> {((this.state.generalData.totalMatchPlayed - this.state.generalData.totalMatchWon)/this.state.generalData.totalMatchPlayed)*100}%</h5>
                            </Row>
                            </Container>
                        </Col>
                </Row>
